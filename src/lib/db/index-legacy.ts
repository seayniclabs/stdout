 ...
 *
 * This file preserved for reference during Phase 1.2 PostgreSQL migration.
 * Original SQLite-only implementation before adapter pattern.
 *
 * DO NOT USE - import from ./index.ts instead
 */
