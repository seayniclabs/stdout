 ...
 * Used internally — prefer getDb() or getDb() in route handlers.
 */
 ...
 */
export function getDb(): BetterSQLite3Database<typeof centralSchema> {
 ...
 */
export function getDb(): BetterSQLite3Database<typeof tenantSchema> {
